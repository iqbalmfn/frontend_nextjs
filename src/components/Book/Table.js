    ...
    <>
      <div className="grid grid-cols-2 mb-5">
        <div className="flex items-center gap-3">
          ...
          item from {isSuccess && data.data.total}
        </div>
      ...
      <Table.wrap>
        {isLoading && <LoadingOverlay label="Memuat..." />}
        <Table>
          <Table.thead>
            ...
            {isSuccess ? (
              data.data.data.map(item => (
                <Table.tr key={item.id}>
                  ...
                  <Table.td>{cutString(item.description, 100)}</Table.td>
                  <Table.td>
                  ...
                  <Table.td className="text-end">
                    <div className="flex items-center gap-1">
                      <button
                        onClick={getBook.bind(this, item.id)}
                      ...
                      <button
                        onClick={handleDeleteBook.bind(this, item.id)}
              ...
              <>
                {(() => {
                  ...
                  for (let i = 1; i <= perPage; i++) {
                    row.push(
                      <Table.tr key={i}>
                        <Table.td className="">tes</Table.td>
                        <Table.td className="">tes</Table.td>
                        <Table.td className="">tes</Table.td>
                        <Table.td className="">tes</Table.td>
                        <Table.td className="">tes</Table.td>
            ...
            <Pagination>
              {isSuccess &&
                data.data.links.map((link, i) => (
                  <Pagination.nav
                    active={data.data.current_page == link.label}
                    disabled={
                      (i === 0 && data.data.current_page === 1) ||
                      (i === data.data.links.length - 1 &&
